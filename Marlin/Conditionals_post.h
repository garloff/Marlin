...
#define HAS_AUTO_BED_FAN (PIN_EXISTS(BED_AUTO_FAN))
#define HAS_AUTO_FAN (HAS_AUTO_FAN_0 || HAS_AUTO_FAN_1 || HAS_AUTO_FAN_2 || HAS_AUTO_FAN_3 || HAS_AUTO_CHAMBER_FAN || HAS_AUTO_BED_FAN)
...
#define AUTO_BED_IS_0 (BED_AUTO_FAN_PIN == E0_AUTO_FAN_PIN)
#define AUTO_BED_IS_1 (BED_AUTO_FAN_PIN == E1_AUTO_FAN_PIN)
#define AUTO_BED_IS_2 (BED_AUTO_FAN_PIN == E2_AUTO_FAN_PIN)
#define AUTO_BED_IS_3 (BED_AUTO_FAN_PIN == E3_AUTO_FAN_PIN)
#define AUTO_BED_IS_4 (BED_AUTO_FAN_PIN == E4_AUTO_FAN_PIN)
#define AUTO_BED_IS_CH (BED_AUTO_FAN_PIN == CHAMBER_AUTO_FAN_PIN)
