 ...
 */
  ...
  #define PID_EXTRUSION_SCALING
    ...
    #define DEFAULT_Kc (60) //heating power=Kc*(e_speed)
    #define LPQ_MAX_LEN 32
  #endif
#endif
...
// Microstep setting (Only functional when stepper driver microstep pins are connected to MCU. M350
...
// Bukito
#define DIGIPOT_MOTOR_CURRENT {135,135,135,185}           // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
